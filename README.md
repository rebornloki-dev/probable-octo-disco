...
- [CHANGELOG.md](CHANGELOG.md) — historique des modifications et notes
- [LICENSE](LICENSE) — licence MIT

Exemples de scripts principaux :

- [`student`](Dictionaries/dictionaries.py) — [Dictionaries/dictionaries.py](Dictionaries/dictionaries.py) : utilisation des dictionnaires et méthodes (`.update()`, `.pop()`, `.get()`).
- [`language`](Conditionals/Basic_conditionals.py) — [Conditionals/Basic_conditionals.py](Conditionals/Basic_conditionals.py) : exemple simple de condition.
- [`tuple_1`](Sets%20%26%20Tuples/tuples.py) — [Sets & Tuples/tuples.py](Sets%20%26%20Tuples/tuples.py) : démonstration de l'immuabilité des tuples.
- [`cs_courses`](Sets%20%26%20Tuples/learning_sets.py) — [Sets & Tuples/learning_sets.py](Sets%20%26%20Tuples/learning_sets.py) : opérations sur les ensembles (union, intersection, différence).
- [`tuple_1`](Practices/test.py) — [Practices/test.py](Practices/test.py) : alias de liste / démonstration de mutabilité.
- [`name`](Practices/practice.py) — [Practices/practice.py](Practices/practice.py) : entrée utilisateur et affichage de texte.
- [`account`](Practices/fakest-bank-youve-seen.py) — [Practices/fakest-bank-youve-seen.py](Practices/fakest-bank-youve-seen.py) : simulation bancaire simple avec un dictionnaire.
- [`analyze_video`](Dumb%20Stuff/frame_counter.py) et [`video_file`](Dumb%20Stuff/frame_counter.py) — [Dumb Stuff/frame_counter.py](Dumb Stuff/frame_counter.py) : analyse vidéo OpenCV affichant la résolution, le nombre total d'images et les images par seconde.
- [`secret`](Dumb%20Stuff/finalfinal.py) — [Dumb Stuff/finalfinal.py](Dumb Stuff/finalfinal.py) : petit jeu de devinette de nombre.
- [`anime`](Dumb%20Stuff/haha.py) — [Dumb Stuff/haha.py](Dumb Stuff/haha.py) : exemple simple de branchement selon la réponse.
- [`counting loop`](Loops%20%26%20Iterations/intro.py) — [Loops & Iterations/intro.py](Loops & Iterations/intro.py) : exemple de boucle avec contrôle `break`.
- [`nested loops`](Loops%20%26%20Iterations/loop.py) — [Loops & Iterations/loop.py](Loops & Iterations/loop.py) : itération imbriquée sur une liste et une chaîne.
- [`while loop`](Loops%20%26%20Iterations/while-loops.py) — [Loops & Iterations/while-loops.py](Loops & Iterations/while-loops.py) : démonstration de boucles infinies et du modèle `break`.
- [`module example`](Modules%20and%20Standard%20Lib/intro.py) — [Modules and Standard Lib/intro.py](Modules and Standard Lib/intro.py) : importe un module d'aide et réutilise une fonction.
- [`helper module`](Modules%20and%20Standard%20Lib/my_module.py) — [Modules and Standard Lib/my_module.py](Modules and Standard Lib/my_module.py) : module réutilisable définissant des fonctions et valeurs exportées.
...
- Exécutez un script avec Python :
  ...
  - python3 Practices/fakest-bank-youve-seen.py
  - python3 Practices/test.py
- Pour l'analyse vidéo, installez OpenCV et modifiez le chemin dans [`video_file`](Dumb%20Stuff/frame_counter.py) ou modifiez le script pour accepter un argument, puis exécutez :
  - pip install opencv-python
  - python3 "Dumb Stuff/frame_counter.py"
...
- Pour modifier le comportement, éditez les petites variables en haut de chaque script (par ex. [`secret`](Dumb%20Stuff/finalfinal.py), [`account`](Practices/fakest-bank-youve-seen.py), [`video_file`](Dumb%20Stuff/frame_counter.py)).
